...
namespace tavara
{
    ...
    class CDLevy : Levy
    {
        ...
        public string Info()
        {
            return "Space: " + Tilaa + " Mb. Speed of writing: " + Nopeus + " kbit/s. Posibility to rewrite: " + MontaTalennus;
        }
    }
    class DVDLevy : Levy
    {
        ...
        public string Info()
        {
            return "Space: " + Tilaa + " Gb. Speed of writing: " + Nopeus + " Mbit/s. Posibility to rewrite: " + MontaTalennus;
        }
    }
    class BluerayLevy : Levy
    {
        ...
        public string Info()
        {
            return "Space: " + Tilaa + " Gb. Speed of writing: " + Nopeus + " Mbit/s. Posibility to rewrite: " + Kerrokset;
        }
    }
    ...
    class Lappari : Laite
    {
        ...
        public string Info()
        {
            return "Weight: " + Paino + " Size of screen: " + NaytonKoko + "''. Brand: " + Merkki + " Memory: " + Muisti + " Tb. Graphic card: " + Videoohjain + " Prosessor: " + Prosessori;
        }
    }
    class Puhelin : Laite
    {
        ...
        public string Info()
        {
            return "Weight: " + Paino + " Size of screen: " + NaytonKoko + "''. Brand: " + Merkki + " Memory: " + Muisti + " Gb. Type: " + Tyyppi + " Camera: " + OnkoKamera;
        }
    }
    class Tabletti : Laite
    {
        ...
        public string Info()
        {
            return "Weight: " + Paino + " Size of screen: " + NaytonKoko + "''. Brand: " + Merkki + " Memory: " + Muisti + " Simcard: " + OnkoSimkortti + " Wi-Fi: " + OnkoWiFi;
        }
    }
}
